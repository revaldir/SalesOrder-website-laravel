...
<div class="form-group">
    ...
    {!! Form::selectMonth('month_id', null, ['placeholder' => 'Select Month', 'class' => $errors->has('month_id') ? 'form-control is-invalid' : 'form-control', 'required', 'autofocus']) !!}
...
{{-- <div class="form-group">
    ...
    {!! Form::select('month', $options['month'], null, ['placeholder' => 'Select Month', 'class' => $errors->has('month') ? 'form-control is-invalid' : 'form-control', 'required', 'autofocus']) !!}
    @if ($errors->has('month'))
    <span class="invalid-feedback">
...
<div class="form-group row">
    ...
    <div class="col-md-4">
        <label for="out_value">Nominal (Rp.) </label>
