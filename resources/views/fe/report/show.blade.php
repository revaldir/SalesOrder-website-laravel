...
<main class="main">
    ...
    <div class="container-fluid">
        <div class="row justify-content-md-center">
            <div class="col-md-1">
                <div class="card">
                    <a href="{{ route('user.reports.index') }}" class="btn btn-lg btn-block btn-outline-light" style="background: #0D276B"><span><i class="fa fa-chevron-left"></i></span></a>
                </div>
            </div>
            <div class="col-md-9">
                <div class="card">
                    ...
                    <table class="table table-hover table-borderless">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                @endif
                                <td>
                                    <a href="{{ route('user.show.cat', ['report' => $rep->month_id, 'category' => $rep->category_id]) }}" class="btn btn-sm btn-outline-primary">
                                        Show
                                        <span>
